...
public class DetailSearch extends AppCompatActivity {
    ...
    public static String EXTRA_DESKRIPSI = "extra_desc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                favorite.setVisibility(View.INVISIBLE);
                unfavorite.setVisibility(View.VISIBLE);
                Toast.makeText(DetailSearch.this, "Added to Favorite", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        unfavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                favorite.setVisibility(View.VISIBLE);
                unfavorite.setVisibility(View.INVISIBLE);
                Toast.makeText(DetailSearch.this, "Remove from Favorite", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
