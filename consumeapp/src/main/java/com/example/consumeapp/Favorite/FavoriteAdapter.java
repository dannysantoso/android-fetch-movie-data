...
import com.example.consumeapp.DetailFavorite;
...
//            image.setImageResource(movie.getMovieImage());
            ...
            movieItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent Intent = new Intent(mContext, DetailFavorite.class);
                    Intent.putExtra(DetailFavorite.EXTRA_TITLE, movie.getMovieTitle());
                    Intent.putExtra(DetailFavorite.EXTRA_DESKRIPSI, movie.getMovieDesc());
                    Intent.putExtra(DetailFavorite.EXTRA_RATE, movie.getMovieRate());
                    Intent.putExtra(DetailFavorite.EXTRA_DATE, movie.getMovieDate());
                    Intent.putExtra(DetailFavorite.EXTRA_IMAGE, movie.getMovieImage());
